    ...
    <div style={{ position: 'relative', userSelect: 'none' }}>
      ...
      >
        ...
        <svg
          ...
          style={{ transform: open ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s', color: 'var(--color-text-muted)' }}
        >
      ...
      {open && (
        <>
          ...
          <div style={{
            ...
            zIndex: 100, boxShadow: '0 10px 25px -5px rgba(0,0,0,0.2)', padding: '4px',
          ...
          <form className={styles.form} onSubmit={handleRegisterSubmit}>
            ...
            <div style={{ marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              <label className={styles.consentRow}>
                ...
                />
                <span className={styles.consentText}>
                  Yüklediğim fotoğraflardaki üçüncü kişi gizliliği için <strong>yüz ve plaka bulanıklaştırma</strong> yapılmasını kabul ediyorum. *
                </span>
              </label>
            </div>
            ...
            <div className={styles.verifyBox}>
              {verifyMethod === 'email' ? (
                <div className={styles.field}>
                  ...
                  <input name="emailCode" className="input" placeholder="6 Haneli E-posta Kodu"
                    value={verifyCodes.emailCode} onChange={handleVerifyChange} maxLength={6}
                    style={{ textAlign: 'center', fontSize: '20px', letterSpacing: '6px', fontWeight: 'bold' }} required />
                </div>
              ) : (
                <div className={styles.field}>
                  ...
                  <input name="smsCode" className="input" placeholder="6 Haneli SMS Kodu"
                    value={verifyCodes.smsCode} onChange={handleVerifyChange} maxLength={6}
                    style={{ textAlign: 'center', fontSize: '20px', letterSpacing: '6px', fontWeight: 'bold' }} required />
                </div>
              )}
            </div>
